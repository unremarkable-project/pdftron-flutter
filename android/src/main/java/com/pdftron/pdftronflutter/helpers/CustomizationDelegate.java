...
public abstract class CustomizationDelegate implements PdfViewCtrlTabHostFragment2.TabHostListener {
    ...
    public CustomizationDelegate(@NonNull Context context, @NonNull PdfViewCtrlTabHostFragment2 tabHostFragment) {
        mContext = context;
